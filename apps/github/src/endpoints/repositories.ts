...
export const listAssignees: Read = {
  declaration: {
    ...
    params: [REPO],
    returns: [
      many(out("logins", "string", { label: text("People", "Personen", "Personas", "Personnes") })),
      COUNT_OUT,
      TOTAL_OUT,
      UNAVAILABLE,
    ],
...
export const listBranches: Read = {
  declaration: {
    ...
    params: [REPO],
    returns: [
      many(out("names", "string", { label: text("Branches", "Branches", "Ramas", "Branches") })),
      COUNT_OUT,
      TOTAL_OUT,
      UNAVAILABLE,
    ],
